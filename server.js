...
const types = { '.html': 'text/html; charset=utf-8', '.jpg': 'image/jpeg', '.mp4': 'video/mp4', '.js': 'text/javascript', '.css': 'text/css', '.svg': 'image/svg+xml' };
...
}).listen(port, () => console.log('kimberly-thankyou on http://localhost:' + port));
